...
from network.blocks import BlockEncoder, AsFeatureMap_down, AsFeatureMap_up, BlockDecoder, BlockFinalImg, Upsample, BlockQ, InitWeights_He
...
class MVAE2D(nn.Module):
    ...
    def __init__(
        ...
        for u in np.arange(num_pool)[::-1]:
            ...
            self.qz.append(BlockQ(nfeatures_from_skip, nfeatures_from_skip, nfeat_latent))
    ...
    def forward(self, x, temp=1, return_cat=False, return_feat=False, verbose=False):
        ...
        # Creating initial feature volume for z_{1}
